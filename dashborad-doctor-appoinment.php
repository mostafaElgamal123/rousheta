...
if(isset($_SESSION['login']['id_user'])){
    ...
    $sql="SELECT * FROM `appoinment_doctor_accept` WHERE (`Patient_name` like '%$search%' OR `Patient_date` like '%$search%' OR `Patient_time` like '%$search%') AND `doctor_id`='$id_user'";
      ...
      <div class="container py-5">
        <div class="table-patient">
            <div class="group-search-patient">
                <form action="<?php URL ?>handlers/search-dash-doc-acc.php" method="POST" class="btn-search">
                    <input type="text" name="search" placeholder="search">
                    <button name="submit" class="icon-search"><i class="fa fa-search"></i></button>
                </form>
            </div>
            <h2><i class="fa fa-table" aria-hidden="true"></i> <span>appoinment patient</span></h2>
            ...
            <table class="table">
                ...
                <?php $i=1; if(isset($result)): foreach($result as $resul): ?>
                  <tr>
                    ...
                    <td>
                        <a class="btn-delete" href="<?php URL ?>handlers/Appoinment-doctor-accept-delete.php?id=<?php echo $resul['app_acc_id']; ?>">
                            delete
                        </a>
                    </td>
                  </tr>
