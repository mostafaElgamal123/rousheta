                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <section class="items-about">
                                ...
                                <form class="row g-3 appoinment" action="<?php echo URL ?>handlers/Appoinment-doctor.php?id=<?php echo $id; ?>" method="POST">
                                    <h2>
                            ...
                            <section class="doctor-review">
                                ...
                                <div class="doctor-review__write-comment">
                                    <div class="text-message">
                                        <form action="<?php URL ?>handlers/add-comment-doc.php?id=<?php echo $id; ?>" method="post">
                                ...
                                <div class="comment-view">
                                    ...
                                    ?>
                                    <a href="<?php URL ?>handlers/delete-comment-doc.php?id=<?php echo $result_commen['comment_id']; ?>&id_doc=<?php echo $id ?>">delete</a>
                                    <?php endif; endif; ?>
                                </div>
