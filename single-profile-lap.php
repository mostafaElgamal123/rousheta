                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <section class="items-about">
                                ...
                                <form class="row g-3 appoinment" action="<?php echo URL ?>handlers/Appoinment-lap.php?id=<?php echo $id; ?>" method="POST">
                                    <h2>
                                    ...
                                    <div class="col-md-6">
                                    <label class="form-label">appoinment time</label>
                                    <input type="time" name="pat_time" class="form-control" placeholder="1234 Main St">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">type test</label>
                                        <input type="text" name="type_test" class="form-control" placeholder="type test">
                                    </div>
                                    <div class="col-12">
                                    <button type="submit" name="appoinment_patient" class="btn btn-primary">appoinment now</button>
                                    </div>
                                </form>
                            ...
                            <section class="doctor-review">
                                ...
                                <div class="doctor-review__write-comment">
                                    <div class="text-message">
                                        <form action="<?php URL ?>handlers/add-comment-lap.php?id=<?php echo $id; ?>" method="post">
                                ...
                                <div class="comment-view">
                                    ...
                                    ?>
                                    <a href="<?php URL ?>handlers/delete-comment-lap.php?id=<?php echo $result_commen['comment_id']; ?>&id_doc=<?php echo $id ?>">delete</a>
                                    <?php endif; endif; ?>
                                </div>
