...
if(isset($_SESSION['login']['id_user'])){
    ...
    $sql="SELECT * FROM `appoinment_doctor` WHERE (`Patient_name` like '%$search%' OR `Patient_date` like '%$search%' OR `Patient_time` like '%$search%') AND `doctor_id`='$id_user' ";
     ...
     <!--end loading-->
      ...
      <div class="container py-5">
        <div class="group-search-patient">
            <form action="<?php URL ?>handlers/search-dash-doc.php" method="POST" class="btn-search">
                  ...
                  <tr>
                    ...
                    <td>
                        <div class="group-btn">
                            ...
                            <a href="<?php URL ?>handlers/Appoinment-doctor-accept.php?id=<?php echo $resul['app_id']; ?>">
                                accept
                            </a>
                            <a href="#!">
                                waiting
                    ...
                    <td>
                        <a class="btn-delete" href="<?php URL ?>handlers/Appoinment-doctor-delete.php?id=<?php echo $resul['app_id']; ?>">
                            delete
                        </a>
                    </td>
                  </tr>
