...
$sql="SELECT * FROM `doctors` WHERE `username` like '%$search%' OR `location` like '%$search%' OR `Specialization` like '%$search%' LIMIT $start_from, $per_page_record";
                ...
                <div class="container py-4">
                    <div class="row g-4">
                            ...
                            <div class="menu-page d-flex justify-content-between align-items-center flex-wrap">
                                <h2>doctors</h2>
                                <div class="search">
                                    <form action="<?php URL ?>handlers/search-doc.php" method="POST">
                                ...
                                <div class="categories">
                                    <ul>
                                        <li class="active" ><a href="<?php URL ?>handlers/search-Specialization-doc.php?search">All</a></li>
                                        <li><a href="<?php URL ?>handlers/search-Specialization-doc.php?search=Stomach">Stomach</a></li>
                                        <li><a href="<?php URL ?>handlers/search-Specialization-doc.php?search=Eyes">Eyes</a></li>
                                        <li><a href="<?php URL ?>handlers/search-Specialization-doc.php?search=Chest">Chest</a></li>
                                        <li><a href="<?php URL ?>handlers/search-Specialization-doc.php?search=Lung">Lung</a></li>
                                        <li><a href="<?php URL ?>handlers/search-Specialization-doc.php?search=Cardiology">Cardiology</a></li>
                                        <li><a href="<?php URL ?>handlers/search-Specialization-doc.php?search=Brain">Brain</a></li>
                                        <li><a href="<?php URL ?>handlers/search-Specialization-doc.php?search=Sergey">Sergey</a></li>
                                    </ul>
                                ...
                                <div class="pagination">
                                    <ul>
                                        <?php
                                            ...
                                            $pagLink = "";     
                                            if($page>=2) {   
                                                echo "<li><a id='prev' href='doctors.php?page=".($page-1)."'>  Prev </a></li>";   
                                            }       
                                                        
                                            for ($i=1; $i<=$total_pages; $i++) {   
                                                if ($i == $page) {   
                                                    $pagLink .= "<li class='active'><a class = 'btn-pagination' href='doctors.php?page="  
                                                                                        .$i."'>".$i." </a> </li>";   
                                                }               
                                                else  {   
                                                    $pagLink .= "<li><a href='doctors.php?page=".$i."'>   
                                                                                        ".$i." </a></li>";     
                                                }   
                                            };     
                                            echo $pagLink;   
                                            ...
                                            if($page<$total_pages){   
                                                echo "<li><a id='next' href='doctors.php?page=".($page+1)."'>  Next </a></li>";   
                                            } 
